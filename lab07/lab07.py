...
def make_glookup(class_assignments):
    ...
    sum_score = 0
    total_score = 0
    def glookup(assignment, score):
        nonlocal sum_score
        nonlocal total_score
        sum_score += score
        total_score += class_assignments[assignment]
        return sum_score / total_score
    return glookup
...
def num_trees(n):
    ...
    *   *        *       *
    ...
    if n<=2:
        return 1
    return sum(num_trees(i)*num_trees(n-i) for i in range(1,n))#catalan number
