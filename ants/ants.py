...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        move=0
        ptr=self.place
        while ptr is not beehive:
              if move>=self.min_range and move<=self.max_range:
                  if rANTdom_else_none(ptr.bees):
                       return rANTdom_else_none(ptr.bees)
              ptr=ptr.entrance 
              move+=1
        return None
        # END Problem 3 and 4
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 5
        "*** YOUR CODE HERE ***"
        save_place=self.place
        Ant.reduce_armor(self,amount)
        if self.armor<=0:
           amount+=self.damage
        iter_bee=save_place.bees[:]
        for bee in iter_bee:    
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        ...
        if isinstance(other, ContainerAnt):
            return False
        elif self.contained_ant is None:
            return True
        # END Problem 9
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        # BEGIN Problem 13
        "*** YOUR CODE HERE ***"
        if QueenAnt.is_true_queen==1:
            QueenAnt.is_true_queen=0
            self.is_true_queen=1
    ...
    def action(self, gamestate):
        ...
        if self.is_true_queen!=1:
            ...
            while ptr is not None:
                if ptr.ant is not None:
                    if isinstance(ptr.ant,ContainerAnt):
                           if ptr.ant.contained_ant is not None and ptr.ant.contained_ant.is_double==False:
                               ptr.ant.contained_ant.is_double=True
                               ptr.ant.contained_ant.damage*=2
                    if ptr.ant.is_double==False:
                       ptr.ant.is_double=True
                       ptr.ant.damage*=2
                ptr=ptr.exit
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 13
        Ant.reduce_armor(self,amount)
        if self.is_true_queen==1 and self.armor<=0:
            bees_win()
