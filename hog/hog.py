...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        if who==0:
            ...
            if abs(num_rolls-t)==2 and feral_hogs:
                score0+=3
            t=take_turn(num_rolls,score1,dice)
            score0+=t
            ...
            if abs(num_rolls-s)==2 and feral_hogs:
                score1+=3
            s=take_turn(num_rolls,score0,dice)
            score1+=s
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    t=free_bacon(opponent_score)
    if t+score<opponent_score and is_swap(t+score,opponent_score):
        return 0
    elif is_swap(t+score,opponent_score):
        return num_rolls
    else :
...
def final_strategy(score, opponent_score):
    ...
    oops,I don't have a final strategy.
    """
    # BEGIN PROBLEM 12
